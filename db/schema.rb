...
ActiveRecord::Schema.define(version: 2021_07_20_065601) do
  ...
  create_table "wallet_transactions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["wallet_id", "transaction_amount"], name: "index_wallet_transactions_on_wallet_id_and_transaction_amount"
  end
